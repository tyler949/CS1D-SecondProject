...
public:
    ...
    QRadioButton *stadiumNameRadio;
    QRadioButton *dateOpenedRadio;
    QLabel *label_10;
    QLabel *label_11;
    QWidget *horizontalLayoutWidget;
    QHBoxLayout *horizontalLayout_4;
    QRadioButton *americanLeagueRadio;
    QRadioButton *nationalLeagueRadio;
    ...
    QPushButton *modifyStadiumButton;
    QPushButton *addTeam;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        stackedWidget->setMaximumSize(QSize(831, 431));
        ...
        page_view_stadiums->setMaximumSize(QSize(831, 431));
        page_view_stadiums->setAutoFillBackground(true);
        backToMain = new QPushButton(page_view_stadiums);
        backToMain->setObjectName(QStringLiteral("backToMain"));
        backToMain->setGeometry(QRect(430, 380, 93, 28));
        viewInformation = new QPushButton(page_view_stadiums);
        viewInformation->setObjectName(QStringLiteral("viewInformation"));
        viewInformation->setGeometry(QRect(540, 380, 101, 28));
        verticalLayoutWidget_6 = new QWidget(page_view_stadiums);
        verticalLayoutWidget_6->setObjectName(QStringLiteral("verticalLayoutWidget_6"));
        verticalLayoutWidget_6->setGeometry(QRect(530, 50, 121, 99));
        verticalLayout_6 = new QVBoxLayout(verticalLayoutWidget_6);
        verticalLayout_6->setSpacing(6);
        verticalLayout_6->setContentsMargins(11, 11, 11, 11);
        verticalLayout_6->setObjectName(QStringLiteral("verticalLayout_6"));
        verticalLayout_6->setContentsMargins(0, 0, 0, 0);
        teamNameRadio = new QRadioButton(verticalLayoutWidget_6);
        teamNameRadio->setObjectName(QStringLiteral("teamNameRadio"));

        verticalLayout_6->addWidget(teamNameRadio);

        stadiumNameRadio = new QRadioButton(verticalLayoutWidget_6);
        stadiumNameRadio->setObjectName(QStringLiteral("stadiumNameRadio"));

        verticalLayout_6->addWidget(stadiumNameRadio);

        dateOpenedRadio = new QRadioButton(verticalLayoutWidget_6);
        dateOpenedRadio->setObjectName(QStringLiteral("dateOpenedRadio"));

        verticalLayout_6->addWidget(dateOpenedRadio);
        ...
        label_11 = new QLabel(page_view_stadiums);
        label_11->setObjectName(QStringLiteral("label_11"));
        label_11->setGeometry(QRect(530, 20, 61, 21));
        horizontalLayoutWidget = new QWidget(page_view_stadiums);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(0, 330, 456, 41));
        horizontalLayout_4 = new QHBoxLayout(horizontalLayoutWidget);
        horizontalLayout_4->setSpacing(6);
        horizontalLayout_4->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_4->setObjectName(QStringLiteral("horizontalLayout_4"));
        horizontalLayout_4->setContentsMargins(0, 0, 0, 0);
        americanLeagueRadio = new QRadioButton(horizontalLayoutWidget);
        americanLeagueRadio->setObjectName(QStringLiteral("americanLeagueRadio"));

        horizontalLayout_4->addWidget(americanLeagueRadio);

        nationalLeagueRadio = new QRadioButton(horizontalLayoutWidget);
        nationalLeagueRadio->setObjectName(QStringLiteral("nationalLeagueRadio"));

        horizontalLayout_4->addWidget(nationalLeagueRadio);

        bothRadio = new QRadioButton(horizontalLayoutWidget);
        bothRadio->setObjectName(QStringLiteral("bothRadio"));

        horizontalLayout_4->addWidget(bothRadio);

        grassRadio = new QRadioButton(horizontalLayoutWidget);
        grassRadio->setObjectName(QStringLiteral("grassRadio"));

        horizontalLayout_4->addWidget(grassRadio);

        tableWidget = new QTableWidget(page_view_stadiums);
        tableWidget->setObjectName(QStringLiteral("tableWidget"));
        tableWidget->setGeometry(QRect(0, 40, 511, 281));
        ...
        backToMain2->setGeometry(QRect(550, 380, 93, 28));
        tableWidget_2 = new QTableWidget(page_plan_trip);
        tableWidget_2->setObjectName(QStringLiteral("tableWidget_2"));
        tableWidget_2->setGeometry(QRect(10, 70, 256, 192));
        tableWidget_3 = new QTableWidget(page_plan_trip);
        tableWidget_3->setObjectName(QStringLiteral("tableWidget_3"));
        tableWidget_3->setGeometry(QRect(430, 70, 256, 192));
        ...
        verticalLayoutWidget_5->setGeometry(QRect(210, 320, 212, 80));
        ...
        backToList->setGeometry(QRect(550, 380, 93, 28));
        ...
        modifyStadiumButton = new QPushButton(verticalLayoutWidget_2);
        modifyStadiumButton->setObjectName(QStringLiteral("modifyStadiumButton"));

        verticalLayout_2->addWidget(modifyStadiumButton);
        ...
        backToList_2->setGeometry(QRect(540, 380, 93, 28));
        ...
        modify->setGeometry(QRect(540, 380, 101, 28));
        ...
        title_2->setGeometry(QRect(190, 20, 161, 16));
        submit = new QPushButton(page_modify_stadium);
        submit->setObjectName(QStringLiteral("submit"));
        submit->setGeometry(QRect(540, 380, 101, 28));
        ...
        backToMain_2->setGeometry(QRect(440, 380, 93, 28));
        ...
        backToMain2_2->setGeometry(QRect(550, 380, 93, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        majorAlphabet->setText(QApplication::translate("MainWindow", "View Stadiums", 0));
        ...
        backToMain->setText(QApplication::translate("MainWindow", "Return", 0));
        viewInformation->setText(QApplication::translate("MainWindow", "Details", 0));
        teamNameRadio->setText(QApplication::translate("MainWindow", "Team Name", 0));
        stadiumNameRadio->setText(QApplication::translate("MainWindow", "Stadium Name", 0));
        dateOpenedRadio->setText(QApplication::translate("MainWindow", "Date Opened", 0));
        label_10->setText(QString());
        label_11->setText(QApplication::translate("MainWindow", "Sort by:", 0));
        americanLeagueRadio->setText(QApplication::translate("MainWindow", "American League", 0));
        nationalLeagueRadio->setText(QApplication::translate("MainWindow", "National League", 0));
        bothRadio->setText(QApplication::translate("MainWindow", "Both", 0));
        grassRadio->setText(QApplication::translate("MainWindow", "Grass Surface", 0));
        backToMain2->setText(QApplication::translate("MainWindow", "return", 0));
        ...
        backToList->setText(QApplication::translate("MainWindow", "return", 0));
        modifyStadiumButton->setText(QApplication::translate("MainWindow", "Modify Stadium", 0));
        ...
        backToList_2->setText(QApplication::translate("MainWindow", "return", 0));
        ...
        title_2->setText(QApplication::translate("MainWindow", "Enter Stadium Information", 0));
        ...
        backToMain_2->setText(QApplication::translate("MainWindow", "return", 0));
        ...
        backToList_3->setText(QApplication::translate("MainWindow", "return", 0));
        selectSouvenirTitle->setText(QApplication::translate("MainWindow", "Select the Souvenir", 0));
        backToMain_3->setText(QApplication::translate("MainWindow", "return", 0));
